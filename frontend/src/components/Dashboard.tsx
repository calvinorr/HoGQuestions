      ...
      <div className="space-y-8">
        <div className="glass-card rounded-2xl p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="px-4 py-2 bg-blue-500/20 text-blue-300 border-blue-500/30 font-semibold rounded-md">22 Types</div>
          </div>

          <h3 className="text-2xl font-bold text-foreground mb-4">Game Management</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-card rounded-2xl p-8">
            <h4 className="text-xl font-semibold mb-4">Question Library</h4>
            <p className="text-foreground/60 mb-6">Create, edit, and organize questions for each game type.</p>
          ...
          <div className="glass-card rounded-2xl p-8">
            <h4 className="text-xl font-semibold mb-4">Session Builder</h4>
            <p className="text-foreground/60 mb-6">Assemble playlists, set timings and live options.</p>
